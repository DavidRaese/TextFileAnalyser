...
import FileAnalyser.raese.ThreadUtils.AnalyzeRunner;
import FileAnalyser.raese.ThreadUtils.WaitingForAnalyzingToFinishRunner;
import FileAnalyser.raese.UIUtils.ProgressBarView;
import FileAnalyser.raese.UIUtils.ProgressCounter;
import FileAnalyser.raese.UIUtils.ProgressLabelView;
import FileAnalyser.raese.fileUtils.*;
...
public class Controller implements Initializable {
    ...
    public void analyseTextFileHandler() {
        ...
        progressCounter.setTotalSize(file.length());
